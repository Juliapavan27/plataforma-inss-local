...
function Hero() {
  return (
    <section className="relative overflow-hidden bg-ink-950 text-white">
      ...
      <div className="container relative grid items-center gap-12 py-14 md:grid-cols-2 md:gap-8 md:py-20">
        {/* Coluna do texto */}
        <div className="text-center md:text-left">
          ...
          <h1 className="mt-6 font-display text-4xl font-black leading-[1.05] text-balance sm:text-5xl">
            O INSS negou o seu benefício?{" "}
            <span className="text-red-400">Você pode recorrer.</span>
          </h1>

          <p className="mx-auto mt-5 max-w-md text-lg font-semibold leading-snug text-white/85 md:mx-0">
            Qualidade técnica, com quem fala a sua língua e entende o seu problema. A gente
            resolve de forma prática, com você.
          </p>
          ...
          <div className="mt-7 flex flex-col items-center gap-3 sm:flex-row md:items-start md:justify-start">
            <a
              ...
              className="inline-flex w-full items-center justify-center gap-2 rounded-xl px-6 py-3.5 text-base font-bold text-white shadow-lift transition hover:-translate-y-0.5 sm:w-auto"
            ...
            <Link
              href="/posso-recorrer"
              className="inline-flex w-full items-center justify-center rounded-xl px-6 py-3.5 text-base font-semibold text-white ring-1 ring-white/25 transition hover:bg-white/10 sm:w-auto"
            >
              Posso recorrer? (grátis)
            </Link>
          </div>

          <div className="mt-6 flex flex-wrap justify-center gap-x-5 gap-y-2 text-sm font-semibold text-white/80 md:justify-start">
            <span className="inline-flex items-center gap-1.5">
              <CheckCircle2 className="h-4 w-4 text-[#25D366]" /> Atendimento humano
            </span>
            <span className="inline-flex items-center gap-1.5">
              <CheckCircle2 className="h-4 w-4 text-[#25D366]" /> Resposta rápida
            </span>
            <span className="inline-flex items-center gap-1.5">
              <CheckCircle2 className="h-4 w-4 text-[#25D366]" /> Sem enrolação
            </span>
          </div>
        </div>

        {/* Imagem: uma conversa de WhatsApp (mostra o atendimento, sem depoimento falso). */}
        <div className="mx-auto w-full max-w-sm">
          <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-ink-900/70 shadow-lift backdrop-blur">
            <div className="flex items-center gap-3 bg-[#075E54] px-4 py-3">
              <span className="grid h-10 w-10 place-items-center rounded-full bg-[#25D366] text-white">
                <WhatsAppGlyph className="h-5 w-5" />
              </span>
              <div className="leading-tight">
                <p className="text-sm font-bold text-white">Recurso Fácil</p>
                <p className="text-xs text-white/70">online agora</p>
              </div>
            </div>
            <div className="space-y-2.5 p-4">
              <div className="max-w-[85%] rounded-2xl rounded-tl-sm bg-white/10 px-4 py-2.5 text-sm leading-relaxed text-white/90">
                Oi, o INSS negou meu auxílio-doença 😔 o que eu faço agora?
              </div>
              <div className="ml-auto max-w-[88%] rounded-2xl rounded-tr-sm bg-[#25D366] px-4 py-2.5 text-sm font-medium leading-relaxed text-ink-950">
                Oi! Fica tranquila 💚 Você tem 30 dias pra recorrer. Me conta o que diz a carta
                que eu te explico o passo a passo, tá?
              </div>
              <div className="flex items-center gap-1.5 pl-1 pt-1 text-xs text-white/40">
    ...
    <section id="precos" className="container scroll-mt-24 py-24">
      <Reveal className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-4 text-lg text-ink-600">
          Do Standard (você faz) ao Diamante (a gente entrega tudo pronto). Pagamento único,
          sem mensalidade.
        </p>
      </Reveal>
        ...
        {MANUAL_DESTAQUE && (
          <div className="flex flex-col rounded-3xl border border-ink-200 bg-white p-8 shadow-soft">
            <span className="chip-brand self-start bg-brand-50 text-brand-700 ring-brand-200">
              <FileText className="h-3.5 w-3.5" /> Plano Standard · você faz
            </span>
        ...
        <div className="relative flex flex-col overflow-hidden rounded-3xl border border-ink-950/10 bg-gradient-to-b from-ink-950 to-[#0a1030] p-8 text-white shadow-lift">
          ...
          <div className="relative flex flex-1 flex-col">
            <span className="chip-dark self-start">
              <Award className="h-3.5 w-3.5 text-gold-400" /> Plano Diamante · a gente faz tudo
            </span>
